<?php
  function svgBadge($cType,$cStatus,$cCol) {
    ...
    echo "<svg xmlns='http://www.w3.org/2000/svg' xmlns:xlink='http://www.w3.org/1999/xlink' width='96' height='20'>";
    echo   "<linearGradient id='b' x2='0' y2='100%'>";
    echo     "<stop offset='0' stop-color='#bbbbbb' stop-opacity='.1'/>";
    echo     "<stop offset='1' stop-opacity='.1'/>";
    echo   "</linearGradient>";
    echo   "<clipPath id='a'>";
    echo     "<rect width='96' height='20' rx='3' fill='#ffffff'/>";
    echo   "</clipPath>";
    echo   "<g clip-path='url(#a)'>";
    echo     "<path fill='#505050' d='M0 0h37v20H0z'/>";
    echo     "<path fill='".$bgCol."' d='M37 0h59v20H37z'/>";
    echo     "<path fill='url(#b)' d='M0 0h96v20H0z'/>";
    echo   "</g>";
    echo   "<g fill='#ffffff' text-anchor='left' font-family='DejaVu Sans,Verdana,Geneva,sans-serif' font-size='110'>";
