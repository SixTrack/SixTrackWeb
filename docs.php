...
<article>
  ...
  <h3>Build Manual</h3>
  <ul>
    <li><a href="/SixTrack/docs/building_sixtrack.pdf">For 4.x: PDF Version</a></li>
    <li><a href="https://github.com/SixTrack/SixTrack/blob/master/doc/build_sixtrack.md">For 5.x: GitHub Document</a></li>
  </ul>

  <h2>Physics References and Code Development</h2>
  <ul>
    <li>1985,
    ...
    <li>2018,
      <a href="https://publishing.cern.ch/index.php/CYRCP/issue/view/74">
      Dynamic Simulations in SixTrack</a>,
      K. Sjobak, V.K. Berglyd Olsen, R. De Maria, M. Fitterer, A. Santamaría García, H. Garcia-Morales, A. Mereghetti,
      J.F. Wagner, S.J. Wretborn.
    </li>
    <li>2019,
      <a href="https://ipac2019.vrws.de/papers/wepts026.pdf">
      Generalised Scattering Module in SixTrack 5</a>,
      K. N. Sjobak, V. K. Berglyd Olsen , H. Burkhardt, R. De Maria.
    </li>
  </ul>
