...
<ul>
  ...
  <a href="http://cds.cern.ch/record/178715/files/DESY-87-036.pdf">
    A non-linear canonical formalism for the coupled synchro-betatron motion
</a>, D.P. Barber, G. Ripken and F. Schmidt, Desy 87-036; thin/thick maps assuming v=beta*c;
   <li> 1995,
  ...
  <!--a href="../doc/ripken_new.pdf"-->
   ...
   <li>2013,
   <a href="http://cds.cern.ch/record/1642385/files/CERN-THESIS-2013-248.pdf">Particle Tracking in Circular Accelerators Using the Exact Hamiltonian in SixTrack</a>,
   M. Fjellstrom;
   <li> 2016,
...
<ul>
  <li> 2006,
    ...
    KEK Preprint 2005-107;
     historical overview of single particle tracking.
     <li> 2002,
    ...
    <li> 1990,
      <!--<a href="../doc/yoshida00.pdf">-->
        <a href="http://www.sciencedirect.com/science/article/pii/0375960190900923">Construction of higher order symplectic integrators</a>,
    H. Yoshida,  Phys. Lett. A 150 (5–7): 262.;
    arbitrary order integrators from solvable maps.
    <li> 1992,
      <a href="http://www.slac.stanford.edu/cgi-wrap/getdoc/slac-pub-10055.pdf"> A Symplectic Beam-Beam Interaction with Energy Change</a>,
      SLAC-PUB-10055, KEK Preprint 92-117;
      Synchro betatron mapping for head-on beam beam effects.
    <li> 1988,
    ...
    <li> 1980,
      <a href="http://cds.cern.ch/record/122227/files/198005132.pdf">Closed expression for the electrical field of a two-dimensional Gaussian charge</a>,
...
Thesis:
<ul>
  <li> 2014, <a href="http://cds.cern.ch/record/1642385/files/CERN-THESIS-2013-248.pdf"> Particle Tracking in Circular Accelerators Using the Exact Hamiltonian in SixTrack</a>, M. Fjellstrom.
  </li>
</ul>
  ...
  <h3> SixDesk </h3>
<ul>
  <li> E. McIntosh et al., <a href=../doc/sixdesk/sixdesk_env.html> SixDesk Enviroment </a>.
  </ul>
</article>
<aside>
    <h2>Content</h2>
    ...
    <ul class="no-bullet-list">
        <li><b>Mailing List:</b><br><a href="mailto:sixtrack-users@cern.ch">sixtrack-users@cern.ch</a></li>
